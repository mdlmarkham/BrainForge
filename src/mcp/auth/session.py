...
class SessionManager:
    ...
    async def get_session(self, session_id: UUID) -> MCPSession | None:
        """Get a session by ID"""
        async with self.database_service.session() as session:
    ...
    async def close_session(self, session_id: UUID) -> MCPSession | None:
        """Close a session"""
    ...
    async def get_execution(self, execution_id: UUID) -> MCPExecution | None:
