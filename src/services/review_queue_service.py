...
from ..models.research_review_queue import (
    ResearchReviewQueue,
...
class ReviewQueueService(SQLAlchemyService[ResearchReviewQueue]):
    ...
    async def get_review_by_content_source(self, db: AsyncSession, content_source_id: UUID) -> ResearchReviewQueue | None:
        """Get review queue entry by content source ID."""

        from sqlalchemy import select

        from ..models.orm.research_review_queue import (
            ResearchReviewQueue as ResearchReviewQueueORM,
        )
