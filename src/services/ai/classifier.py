...
class ContentClassifier:
    ...
    async def classify_content(self, content_source: ContentSource) -> ContentClassification | None:
    ...
    def _parse_classification_response(self, response: str) -> ContentClassification | None:
