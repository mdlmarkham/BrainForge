...
class ContentSummarizer:
    ...
    async def summarize_content(self, content_source: ContentSource) -> str | None:
    ...
    async def generate_comparative_summary(self, content_sources: list, research_topic: str) -> str | None:
