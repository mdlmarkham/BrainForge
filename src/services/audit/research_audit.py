...
from ...models.research_audit_trail import ResearchAuditTrail, ResearchAuditTrailCreate, AuditEventType
...
class ResearchAuditService(SQLAlchemyService[ResearchAuditTrail]):
    ...
    async def log_event(
        ...
        integration_proposal_id: Optional[UUID] = None,
        review_queue_id: Optional[UUID] = None
    ) -> ResearchAuditTrail:
        """Log an audit event."""
    ...
    async def get_audit_trail_for_research_run(
        ...
        from ...models.orm.research_audit_trail import ResearchAuditTrail as ResearchAuditTrailORM
...
class ResearchAuditLogger:
    ...
    async def log_research_start(self, db: AsyncSession, research_run_id: UUID, 
                               search_query: str, user_id: Optional[UUID] = None) -> ResearchAuditTrail:
    ...
    async def log_quality_assessment(self, db: AsyncSession, research_run_id: UUID,
                                   ...
                                   content_source_id: Optional[UUID] = None) -> ResearchAuditTrail:
    ...
    async def log_review_decision(self, db: AsyncSession, research_run_id: UUID,
                                decision: str, implementation_notes: Optional[str],
    ...
    async def log_error(self, db: AsyncSession, research_run_id: UUID,
                      error_message: str, error_type: str, stack_trace: Optional[str] = None,
                      content_source_id: Optional[UUID] = None) -> ResearchAuditTrail:
        """Log error event."""
