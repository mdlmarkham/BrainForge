...
from src.services.obsidian import ObsidianService, ObsidianNote, ObsidianServerInfo


async def test_connection(base_url: str, token: Optional[str] = None) -> bool:
...
async def list_vault_files(base_url: str, token: Optional[str] = None, directory: str = '') -> None:
...
async def get_note(base_url: str, token: Optional[str] = None, filename: str = '', as_json: bool = False) -> None:
...
async def get_active_note(base_url: str, token: Optional[str] = None, as_json: bool = False) -> None:
...
async def sync_vault(base_url: str, token: Optional[str] = None) -> None:
